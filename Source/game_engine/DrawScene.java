...
public class DrawScene extends UpdateObjects {
 ...
 private void evilHeadBehaviour() {
  if (Dragon.dragons.isEmpty() && Gold.goldstack.isEmpty() && lifeBunker >= 50 && EvilHead.evilHead.x - MyShip.myShip.x == 400 && timerEasy.isRunning() == true) {
   EvilHead.evilHead.throwCanons();
   EvilHead.evilHead.strikeHead();
  }


  if (Dragon.dragons.isEmpty() && Gold.goldstack.isEmpty() && lifeBunker >= 50 && EvilHead.evilHead.x - MyShip.myShip.x == 400 && timerMedium.isRunning() == true) {
   EvilHead.evilHead.throwFireballs();
   EvilHead.evilHead.strikeHead();
  }

  if (Dragon.dragons.isEmpty() && Gold.goldstack.size() >= 0 && lifeBunker >= 50 && EvilHead.evilHead.x - MyShip.myShip.x == 400 && timerHard.isRunning() == true) {
   EvilHead.evilHead.throwFireballs();
   EvilHead.evilHead.strikeHead();
  }

  if (EvilHead.evilHead.x - MyShip.myShip.x > 800 && Dragon.dragons.isEmpty() && Gold.goldstack.isEmpty() && lifeBunker >= 50) {
 ...
 private void stateWeaponsL4(Graphics g) {
  ...
  if (Dragon.dragons.isEmpty() && lifeBunker >= 50 && Gold.goldstack.size() > 0 && ingame == true) {
 ...
 private void setBG1(Graphics g) {
  if (EvilHead.evilHead.isVisible() && MyShip.myShip.isVisible() && VolBtn.volButt.isVisible() && Bunker.bunkerObj.isVisible() && g.drawImage(bg1, 0, 0, null)) {
 ...
 private void setBG2(Graphics g) {
  if (EvilHead.evilHead.isVisible() && MyShip.myShip.isVisible() && VolBtn.volButt.isVisible() && Bunker.bunkerObj.isVisible() && g.drawImage(bg2, 0, 0, null)) {
   g.drawImage(MyShip.myShip.getImage(), MyShip.myShip.getX(), MyShip.myShip.getY(),
    this);
   g.drawImage(EvilHead.evilHead.getImage(), EvilHead.evilHead.getX(), EvilHead.evilHead.getY(),
    this);
